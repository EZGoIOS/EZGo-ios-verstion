...
class Q2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btn3.frame = CGRect(x: Int((fullScreenSize.width * 0.15)) , y:Int((fullScreenSize.height * 0.73)) , width: Int((fullScreenSize.width * 0.7)) , height: Int((fullScreenSize.height * 0.07)))
        btn3.setBackgroundImage(UIImage(named: "optionc" ), for: UIControlState.normal)

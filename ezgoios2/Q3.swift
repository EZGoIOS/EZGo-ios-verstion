...
class Q3: UIViewController {
    ...
    @IBAction func btn4(_ sender: Any) {
        answer = 4
        btn4.setBackgroundImage(UIImage(named: "optionclick_d" ), for: UIControlState.normal)
        btn1.setBackgroundImage(UIImage(named: "optiona" ), for: UIControlState.normal)
        btn2.setBackgroundImage(UIImage(named: "optionb" ), for: UIControlState.normal)
        btn3.setBackgroundImage(UIImage(named: "optionc" ), for: UIControlState.normal)
    ...
    override func viewDidLoad() {
        ...
        lblshow.text = "Q" + String(aaaa) + "\n作答了" + String(frequency) + "次"
        if frequency == 1{
            ...
            btn4.setTitle(option[3], for: UIControlState.normal)
